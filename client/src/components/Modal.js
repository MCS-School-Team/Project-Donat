...
const Modal = ({active,setActive,address}) => {
  ...
  useEffect(() => {
    (async () => {
       ...
       setDonate(formatEther( await signedContract.check_donate()))
    })()
  },[active])
   console.log(donate)
   console.log(address)
                           ...
                           <div className='border flex justify-center items-center border-solid border-black w-11/12 h-1/3 rounded-2xl  '>
                             {donate === undefined?(""): (
                              <div className='flex h-full flex-col justify-around items-center'>
                                <h1>You can withdraw {donate}</h1>
                                <button className='p-2  bg-blue rounded-xl text-white'>withdraw</button>
                              </div>
                              )}  
                           </div>
                        </div>
