                    ...
                    <ul className=" flex   w-[1250px]  ">
                        <div className="  flex   w-full flex-wrap ">
                            {items.map((item, index) => (
                                <li key={index}>
                                    <div
                                        className="flex bg-white-r items-center text-[25px] rounded-lg  p-9 ml-7 mt-3 mb-4 flex-col drop-shadow-xl">
                                        {item.image}
                                        {name}
                                        <button onClick={() => modal(0)}
                                                className="text-[17px] w-10/12 rounded-lg h-10 mt-4 text-white bg-blue">Learn
                                            more
                                        </button>
                                    </div>
                                </li>
